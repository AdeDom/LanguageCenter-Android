...
class AddChatGroupNewUseCaseImpl(
    ...
    override suspend fun invoke(addChatGroupNewRequest: AddChatGroupNewRequest): Resource<BaseResponse> {
        return repository.callAddChatGroupNew(addChatGroupNewRequest)
    }
}
